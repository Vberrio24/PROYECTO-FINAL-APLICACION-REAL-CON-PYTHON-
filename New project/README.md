...
El bot no depende de VS Code. Debe ejecutarse como worker en un servicio en la nube.
...
Se uso asistencia de IA para planear el alcance del proyecto, mejorar la estructura, redactar documentacion y apoyar la implementacion. Los integrantes deben revisar y comprender cada modulo antes de la sustentacion.
